...
<section id="banner">
    ...
    <p>
        <strong>sign up</strong> now and help us grow
        <br />
    ...
    <footer>
        <ul class="buttons vertical">
            <li><a href="#main" class="button fit scrolly">Sign Up</a></li>
        </ul>
    </footer>
    </div>    
</section>
        ...
        <div class="row">
            <div class="12u">
                <ul class="buttons">
                    ...
                    <li><a href="Login.jsp" class="button special">Already a member?</a></li>
                </ul>
            </div>
        </div>
    </form>
